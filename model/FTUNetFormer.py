...
class EfficientSelfAttention(nn.Module):
    def __init__(self,*,dim,heads,reduction_ratio):
        ...
        self.to_out = nn.Conv2d(dim//2,dim,1,bias=False)
...
class FTUNetFormer(nn.Module):
    ...
    def __init__(self,
        ...
        self.backbone1 = SwinTransformerV2(embed_dim=embed_dim, depths=depths, num_heads=num_heads, frozen_stages=freeze_stages)
        self.backbone2 = SwinTransformerV2(in_chans=1,embed_dim=embed_dim, depths=depths, num_heads=num_heads, frozen_stages=freeze_stages)
        encoder_channels = [embed_dim, embed_dim*2, embed_dim*4, embed_dim*8]
        self.decoder = Decoder(encoder_channels, decode_channels, dropout, window_size, num_classes)
        self.weight_coinfficient = weight_coinfficient
    ...
    def forward(self, x):
        ...
        # color = x[:, :3]
        # depth = x[:, 3:]
        res1_c, res2_c, res3_c, res4_c = self.backbone1(x)
        ...
        # x = self.decoder(res1_c+res1_d * self.weight_coinfficient, res2_c+res2_d *self.weight_coinfficient, res3_c+res3_d*self.weight_coinfficient, res4_c+res4_d*self.weight_coinfficient, h, w)
        return x
...
def ft_unetformer(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=256,
                ...
                #   weight_path='pretrain/swinv2_base_patch4_window12to16_192to256_22kto1k_ft.pth'):
                    weight_path='/home/zhao/SSRS/SAM_RS/swinv2_base_patch4_window16_256.pth'):
