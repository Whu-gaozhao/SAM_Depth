...
WINDOW_SIZE = (256, 256) # Vaihingen Patch size
# WINDOW_SIZE = (512, 512) # Potsdam Patch size

STRIDE = 32 # Stride for testing
IN_CHANNELS = 3 # Number of input channels (e.g. RGB)
# IN_CHANNELS = 4 # Number of input channels (e.g. RGB and DEPTH)
FOLDER = "/home/zhao/DataSets/ISPRS_dataset/" # Replace with your "/path/to/the/ISPRS/dataset/folder/"
...
if DATASET == 'Vaihingen':
    ...
    DATA_FOLDER = MAIN_FOLDER + 'ndsm/top_mosaic_09cm_area{}.tif'
    LABEL_FOLDER = MAIN_FOLDER + 'gts_for_participants/top_mosaic_09cm_area{}.tif'
    # BOUNDARY_FOLDER = MAIN_FOLDER + 'sam_boundary_merge/ISPRS_merge_{}.tif'
    BOUNDARY_FOLDER = MAIN_FOLDER + 'SAM_B_M/ISPRS_merge_{}.tif'
    # OBJECT_FOLDER = MAIN_FOLDER + 'V_merge/top_mosaic_09cm_area{}_objects.tif'
    OBJECT_FOLDER = MAIN_FOLDER + 'SAM_O_M/ISPRS_OBJECT_merge_{}.tif'
    ERODED_FOLDER = MAIN_FOLDER + 'gts_eroded_for_participants/top_mosaic_09cm_area{}_noBoundary.tif'
elif DATASET == 'Potsdam':
    train_ids = ['1', '3', '6', '5', '9', '8', '10', '12', '13', '15', '16', '14','18','19','20','21','22','23']
    test_ids = ['7','11','2','4','17','24']
    Stride_Size = 32
    MAIN_FOLDER = FOLDER + 'Potsdam/'
    DATA_FOLDER = MAIN_FOLDER + 'ndsm/top_potsdam_{}_IRRG.tif'
    LABEL_FOLDER = MAIN_FOLDER + '5_Labels_for_participants/top_potsdam_{}_label.tif'
    BOUNDARY_FOLDER = MAIN_FOLDER + 'SAM_B_M/ISPRS_merge_{}.tif'
    OBJECT_FOLDER = MAIN_FOLDER + 'SAM_O_M/ISPRS_merge_{}.tif'
    ...
    def __getitem__(self, i):
        ...
        if random_idx in self.data_cache_.keys():
            ...
            if DATASET == 'Potsdam':
                ...
                ## IRRG
                # data = io.imread(self.data_files[random_idx])[:, :, (3, 0, 1, 2)][:, :, :4].transpose((2, 0, 1))
