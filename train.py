...
# from model.UNetFormer_depth import UNetFormer_depth
        ...
        if e % save_epoch == 0:
            ...
            if MIoU > MIoU_best:
                if DATASET == 'Vaihingen':
                    torch.save(net.state_dict(), '/home/zhao/DataSets/ISPRS_dataset/Vaihingen/Result/UNetformer-AddDepth/{}_epoch{}_{}'.format(MODEL, e, MIoU))
                elif DATASET == 'Potsdam':
                    torch.save(net.state_dict(), '/home/zhao/DataSets/ISPRS_dataset/Potsdam/Result/ABCNet/{}_epoch{}_{}'.format(MODEL, e, MIoU))                    
                elif DATASET == 'Urban':
...
if MODE == 'Train':
    ...
    if DATASET == 'Vaihingen':
        net.load_state_dict(torch.load('/home/zhao/DataSets/ISPRS_dataset/Vaihingen/Result/ABCNet/ABCNet_epoch34_0.7083420693748407')) # sam
        net.eval()
        ...
        for p, id_ in zip(all_preds, test_ids):
            ...
            io.imsave('/home/zhao/DataSets/ISPRS_dataset/Vaihingen/Result/ABCNet/visualize_result/inference_'+MODEL+'_tile_{}.png'.format(id_), img)
    elif DATASET == 'Potsdam':
        net.load_state_dict(torch.load('/home/zhao/DataSets/ISPRS_dataset/Potsdam/Result/UNetformer/UNetformer_epoch30_0.8433119832160137')) # sam
        net.eval()
        MIoU, all_preds, all_gts = test(net, test_ids, all=True, stride=32)
        print("MIoU: ", MIoU)
        for p, id_ in zip(all_preds, test_ids):
            img = convert_to_color(p)
            # plt.imshow(img) and plt.show()
            io.imsave('/home/zhao/DataSets/ISPRS_dataset/Potsdam/Result/UNetformer/viualize_result/inference_'+MODEL+'_tile_{}.png'.format(id_), img)
    elif DATASET == 'Urban':
