...
path = r"/home/zhao/DataSets/ISPRS_dataset/Potsdam/3_Ortho_IRRG/"
list = []
filelist = os.listdir(path)
for file in filelist:
    if '.tif' in file:
        ...
        ind = str(int(file.split('_')[2].replace('_IRRG', '').replace('.tif', '')))
        ...
        if ind in ids:
            ...
            name = '/home/zhao/DataSets/ISPRS_dataset/Potsdam/crop/'
            frmt = '.tif'
            # ind = str(int(file.split('_')[2])) + '_' + str(int(file.split('_')[3]))
