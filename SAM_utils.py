...
device ='cuda'
sam = sam_model_registry ["vit_h"] (checkpoint ="/home/zhao/SSRS/SAM_RS/sam_vit_h_4b8939.pth")
...
directory_name='/home/zhao/DataSets/ISPRS_dataset/Potsdam/crop/'
# directory_name='/home/zhao/DataSets/ISPRS_dataset/Vaihingen/ISPRS_semantic_labeling_Vaihingen_ground_truth_COMPLETE'
...
for img_input in img_list:
    ...
    if img_input.endswith('.tif'):
        ...
        image_boundary.save("/home/zhao/DataSets/ISPRS_dataset/Potsdam/sam_with_crop_boundary/"+img_name+image_type)
        image_objects.save("/home/zhao/DataSets/ISPRS_dataset/Potsdam/sam_with_crop_object/"+img_name+'_objects'+image_type)
end_time = time.time()
